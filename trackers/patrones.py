...
def tracker_amarillo(frame, prev_x, prev_y, trajectory, is_tracking):
...
def stream_video():
    ...
    while True:
        ...
        frame, prev_x, prev_y, trajectory = tracker_amarillo(frame, prev_x, prev_y, trajectory, is_tracking)
